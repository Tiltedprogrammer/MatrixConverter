...
m1 :: QTree Int
m1 = QNode (QNode (QNode (QVal 1) QNone QNone (QVal 2)) QNone QNone (QNode (QVal 3) QNone QNone (QVal 4))) QNone QNone (QNode (QNode (QVal 5) QNone QNone (QVal 6)) QNone  QNone (QNode (QVal 7) QNone QNone (QVal 8)))
